        ...
        <>
          ...
          <div className="flex items-center gap-15">
            ...
            <div 
              ...
              className="w-[200px] bg-[#dd7f81] rounded-xl text-white p-3 mb-4 hover:bg-pink-50 hover:shadow-sm transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
              {/* X icon */}
              <svg 
            ...
            <div 
              ...
              className="w-[200px] bg-[#4A3B8D] rounded-xl text-white p-3 mb-4 hover:bg-pink-50 hover:shadow-sm transition-colors cursor-pointer flex items-center justify-center gap-2"
            >
              {/* Star/Trophy icon */}
              <svg 
                className="w-5 h-5 text-white" 
